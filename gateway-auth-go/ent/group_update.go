...
func (_u *GroupUpdate) AddRoleIDs(ids ...int) *GroupUpdate {
...
func (_u *GroupUpdate) RemoveRoleIDs(ids ...int) *GroupUpdate {
...
// AddRoleIDs adds the "roles" edge to the Role entity by IDs.
func (_u *GroupUpdateOne) AddRoleIDs(ids ...int) *GroupUpdateOne {
	_u.mutation.AddRoleIDs(ids...)
	return _u
}
...
// RemoveRoleIDs removes the "roles" edge to Role entities by IDs.
func (_u *GroupUpdateOne) RemoveRoleIDs(ids ...int) *GroupUpdateOne {
	_u.mutation.RemoveRoleIDs(ids...)
	return _u
}
