...
func (_c *PermissionCreate) SetAccessLevel(v permission.AccessLevel) *PermissionCreate {
	_c.mutation.SetAccessLevel(v)
	return _c
}

// SetNillableAccessLevel sets the "access_level" field if the given value is not nil.
func (_c *PermissionCreate) SetNillableAccessLevel(v *permission.AccessLevel) *PermissionCreate {
	if v != nil {
		_c.SetAccessLevel(*v)
	}
	return _c
...
func (_c *PermissionCreate) SetObjectID(v int) *PermissionCreate {
	_c.mutation.SetObjectID(v)
	return _c
}

// SetNillableObjectID sets the "object_id" field if the given value is not nil.
func (_c *PermissionCreate) SetNillableObjectID(v *int) *PermissionCreate {
	if v != nil {
		_c.SetObjectID(*v)
	}
	return _c
...
func (_c *PermissionCreate) SetObjectType(v string) *PermissionCreate {
	_c.mutation.SetObjectType(v)
	return _c
}

// SetNillableObjectType sets the "object_type" field if the given value is not nil.
func (_c *PermissionCreate) SetNillableObjectType(v *string) *PermissionCreate {
	if v != nil {
		_c.SetObjectType(*v)
	}
	return _c
...
func (_c *PermissionCreate) defaults() {
	if _, ok := _c.mutation.AccessLevel(); !ok {
		v := permission.DefaultAccessLevel
		_c.mutation.SetAccessLevel(v)
	}
}
...
func (_c *PermissionCreate) check() error {
	if _, ok := _c.mutation.AccessLevel(); !ok {
		return &ValidationError{Name: "access_level", err: errors.New(`ent: missing required field "Permission.access_level"`)}
	}
