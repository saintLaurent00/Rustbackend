...
func (_u *RoleUpdate) AddGroupIDs(ids ...int) *RoleUpdate {
...
func (_u *RoleUpdate) RemoveGroupIDs(ids ...int) *RoleUpdate {
...
// AddGroupIDs adds the "groups" edge to the Group entity by IDs.
func (_u *RoleUpdateOne) AddGroupIDs(ids ...int) *RoleUpdateOne {
	_u.mutation.AddGroupIDs(ids...)
	return _u
}
...
// RemoveGroupIDs removes the "groups" edge to Group entities by IDs.
func (_u *RoleUpdateOne) RemoveGroupIDs(ids ...int) *RoleUpdateOne {
	_u.mutation.RemoveGroupIDs(ids...)
	return _u
}
